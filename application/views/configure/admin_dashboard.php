<div class="row">
	<div class="col-md-3">
		<ul>
			...
			?>
			<li>All User Beats This months:<?php echo $Beats; ?></li>
			<li>All User Approved Beats This months: <?php echo $approved; ?></li>
			<li>All User Pending Beats This months: <?php echo $pending; ?></li>
			<li>All User Rejected Beats This months: <?php echo $rejected; ?></li>
			<li>All User Sold Beats This months: <?php echo $sold; ?></li>
		</ul>
		<a href="<?php echo base_url('configure/my_rack');?>">View All User Beats</a>
	</div>
	...
	<div class="col-md-3">
		<ul>
			<li>Users This months:<?php echo count($allusers); ?></li>
		</ul>
		<a href="<?php echo base_url('configure/view_user');?>">View All Users</a>
	</div>
</div>
